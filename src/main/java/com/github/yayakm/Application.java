...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(generator.generateText(10, 10));
        ...
        String text1 = generator2.generateText(10, 20);
        System.out.println(text1);

        generator2.setRegExp("[0-9]{5}");
        String text2 = generator2.generateText(5, 5);
        ...
        System.out.println(generator3.generateText(5, 6));
        ...
        // Uncomment the following lines to test with very large lengths.
         ...
         System.out.println(generator4.generateText());
    }
}
